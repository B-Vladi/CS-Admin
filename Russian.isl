...
; *** Common wizard text
ClickNext=Для продолжения установки необходимо подключение к сети интернет.
BeveledLabel=
...
SelectDirDesc=Выберите папку, в которой установлена игра Counter-Strike 1.6
...
WizardReady=Результат проверки данных
...
ReadyLabel2b=После установки, в вашу игру «Counter-Strike 1.6» будут добавлены файлы, необходимые для получения прав администратора на сервере «CS~console.ru».%n%nДля восстановления прав администратора, удалите эту программу и запустите установку повторно.%n%nНажмите «Установить», чтобы начать установку «CS~console.ru», или «Отмена», для выхода.
...
FinishedLabel=Программа «CS~console.ru» успешно установлена на ваш компьютер.%n%nТеперь вам доступны права администратора на сервере «CS~console.ru».%n%nДля удаления данной программы запустите соответствующий ярлык из меню «Пуск -> CS~console.ru».
ClickFinish=Нажмите «Завершить» и прочитайте документацию (откроется автоматически).
...
ProgramOnTheWeb=Перейти на сайт %1
UninstallProgram=Удалить
